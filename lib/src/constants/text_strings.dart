...
// -- Splash Screen Text
const String tAppName = "SecureGuard";
const String tAppTagLine = "Protect Yourself. \nFree For Everyone";


// -- On Boarding Text
const String tOnBoardingTitle1 = "LOG IN & SIGN UP";
const String tOnBoardingTitle2 = "Clean Your Phone From Virus";
const String tOnBoardingTitle3 = "Give US Your Feedback";
const String tOnBoardingSubTitle1 = "Can You LOG IN & SIGN UP With Your Account In Google.";
const String tOnBoardingSubTitle2 = "Get System Of Antivirus To Clean Your Phone Easy, Safety and Free.";
const String tOnBoardingSubTitle3 = "Lastly Give Me Your Feedback For Using This Application.";
...
// -- Welcome Screen Text
const String tWelcomeTitle = "Scan Your Phone";
const String tWelcomeSubTitle = "LOG IN & SIGN UP With Your Account In Google.";
...
const String tSignUpSubTitle = "Create your profile to start Scan...";
...
const String tDashboardTitle = "Hey, Scan with SecureGuard";
const String tDashboardHeading = "Scan Your Phone";
...
const String tProfileHeading = "Secure Guard";
const String tProfileSubHeading = "superAdmin@secureguard.com";
// -- Menu
...
const String tJoinedAt = " 17 DEC 2024";